  ...
  <b-navbar toggleable="lg" >
    <b-navbar-brand class="logo1">
      <router-link to="/" class="menu-item">
        <span class="frontend1">Qexon</span>
        <span class="social1">Restaurant</span>
      </router-link>
    </b-navbar-brand>
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav>
        <b-nav-item class="menu-item1"><router-link to="/learn" class="textColor"></router-link></b-nav-item>
        <b-nav-item class="menu-item1"><router-link to="/jobs" class="textColor"></router-link></b-nav-item>
        <b-nav-item class="menu-item1"><router-link to="/interview" class="textColor"></router-link></b-nav-item>
        <b-nav-item class="menu-item1"><router-link to="/code-challenge" class="textColor"></router-link></b-nav-item>
        <b-nav-item class="menu-item1"><router-link to="/conferences" class="textColor"></router-link></b-nav-item>
        <b-nav-item class="menu-item1"><router-link to="/city" class="textColor"></router-link></b-nav-item>
      </b-navbar-nav>
...
<style scoped lang="scss">
  .header1{
    border-bottom: 7px solid #606e82;
  }
  .logo1{
    text-align: left;
